...
<%@ page import="kibwa.campus.dto.BusinessDTO" %>
<%@ page language="java" contentType="text/html; charset=utf-8"
         pageEncoding="utf-8" %>

<%
    List<BusinessDTO>pList = (List<BusinessDTO>) request.getAttribute("pList");

    //게시판 조회 결과 보여주기
    if (pList == null) {
        pList = new ArrayList<BusinessDTO>();
    }
        ...
        <div id="board-list">
            <div class="container">
                <table class="board-table">
                    ...
                    <% if (pList.isEmpty()) { %>
                    <tr>
                        <td colspan="5"> 등록된 요청이 없습니다.</td>
                    </tr>
                    <% } else {%>
                    <%for (BusinessDTO b : pList) {%>
                    <tr>
                        <td><%=b.getRownum()%>
                        </td>
                        <td><a href="javascript:goToBoardView('<%=b.getBusiness_num()%>')"><%=b.getBusiness_name()%>
                        </a></td>
                        <td><a><%=b.getBusiness_id()%>
                        </a></td>
                    </tr>
                    <%}%>
                    <%}%>
